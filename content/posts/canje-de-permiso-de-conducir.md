...
- Ex.: [Exemplo de canje](/espanha-dicas/posts/exemplo-de-canje/)
...
2. Consulte se o Brasil confirmou neste [link](https://sedeapl.dgt.gob.es/WEB_NCIT_CONSULTA/consultacanjes/consultarCitaCanjes.faces).
   ...
   - Quando a situação estiver **CONTESTADA** está tudo certo para prosseguir e você deve ter recebido uma confirmação por e-mail.
